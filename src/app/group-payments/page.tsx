          ...
          >
              <div className="max-w-xl mx-auto bg-black/40 backdrop-blur-xl p-8 rounded-2xl border border-green-500/20">
                ...
                <form onSubmit={handleCreatePayment} className="space-y-6">
                  ...
                  <div>
                    <label className="block mb-2 text-green-400">Total Amount (EDU)</label>
                    <input
                      type="number"
                      value={amount}
              ...
              <div className="max-w-xl mx-auto">
                ...
                >
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <div>
                      <label className="block mb-2 text-green-400">Amount (EDU)</label>
                      <input
                        type="number"
                        value={amount}
                        onChange={(e) => setAmount(e.target.value)}
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between mt-2 text-sm">
            ...
            <span className="text-green-400 font-medium">
              {formatAmount(payment.amountCollected)} / {formatAmount(payment.totalAmount)} EDU
            </span>
          </div>
        </div>
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <span>Contribute {formatAmount(payment.amountPerPerson)} EDU</span>
                </>
              )}
            </motion.button>
          )}
